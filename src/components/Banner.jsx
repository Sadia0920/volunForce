...
export default function Banner() {
  ...
  <div className="carousel carousel-vertical rounded-box h-[400px]">
  <div className="carousel-item h-full w-full">
    <img src={volunteer3} className='w-[900px]'/>
  </div>
  <div className="carousel-item h-full w-full">
    <img src={volunteer1} className='w-[900px]' />
  </div>
  <div className="carousel-item h-full w-full">
    <img src={volunteer2} className='w-[900px]'/>
  </div>
  <div className="carousel-item h-full w-full">
    <img src={volunteer4} className='w-[900px]'/>
  </div>
  </div>
  </div>
  )
