...
export default function FAQ() {
  ...
  <div className="collapse collapse-arrow bg-[rgb(168,224,92,0.3)] mb-3">
  ...
  <div className="collapse collapse-arrow bg-[rgb(255,111,0,0.3)] mb-3">
    <input type="radio" name="my-accordion-2" />
  ...
  <div className="collapse collapse-arrow bg-[rgb(255,111,0,0.3)]">
    <input type="radio" name="my-accordion-2" />
